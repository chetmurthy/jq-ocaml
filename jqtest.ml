...
let execute = "execute" >::: [
  ...
  ; "ok-builtins" >:: (fun ctxt -> List.iter (success ~builtins:true) [
        ([], ".", [])
      ; (["0"], "0", ["null"])
      ; (["[2,3,4]"], "def add1: .+1; map(add1)", ["[1,2,3]"])
  ...
  ; "path" >:: (fun ctxt -> List.iter success [
      ...
      ; (["[]"; "[\"a\"]"; "[\"b\"]"], {|path(..)|}, [{|{"a":1,"b":2}|}])
      ; (["[]"; "[\"a\"]"; "[\"a\",\"b\"]"], {|path(..)|}, [{|{"a":{"b":1}}|}])
      ; ([{|["a",0,"b"]|}], {|path(.a[0].b)|}, [{|null|}])
      ; ([{|1|}], {|getpath(["a",0,"b"])|}, [{|{"a":[{"b":1}]}|}])
      ; ([{|1|}; {|[{"b":1}]|}], {|getpath(["a",0,"b"], ["a"])|}, [{|{"a":[{"b":1}]}|}])
      ; ([{|{"a":[{"b":3}],"b":2}|};{|{"a":[{"b":1}],"b":3}|}], {|setpath(["a",0,"b"], ["b"]; 3)|}, [{|{"a":[{"b":1}],"b":2}|}])
      ; ([{|{"a":[{"b":3}],"b":2}|}; {|{"a":[{"b":4}],"b":2}|}], {|setpath(["a",0,"b"]; (3,4))|}, [{|{"a":[{"b":1}],"b":2}|}])
      ; ([{|null|}], "delpaths([[0]])", [{|null|}])
      ; ([{|[]|}], "delpaths([[0]])", [{|[]|}])
      ; ([{|{}|}], {|delpaths([["a"]])|}, [{|{}|}])
      ; ([{|[]|}], "delpaths([[0]])", [{|[0]|}])
      ; ([{|[1,2]|}], "delpaths([[0]])", [{|[0,1,2]|}])
      ; ([{|[0,2]|}], "delpaths([[1]])", [{|[0,1,2]|}])
      ; ([{|[0,1]|}], "delpaths([[2]])", [{|[0,1,2]|}])
      ; ([{|[0,1,2]|}], "delpaths([[3]])", [{|[0,1,2]|}])
      ; ([{|{}|}], {|delpaths([["a","b"]])|}, [{|{"a":{}}|}])
      ; ([{|{"c":2}|}], {|delpaths([["a","b"]])|}, [{|{"a":{"b":3},"c":2}|}])
      ]
      )
